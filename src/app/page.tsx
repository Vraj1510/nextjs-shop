...
export default async function Home() {
  ...
  return (
    <>
      <HeroSection showLink></HeroSection>
      ...
      {isFeaturedGame && (
        <>
          ...
          {isFeaturedGame.map((featuredGame) => (
            <>
      ...
      >
        <div className={styles.categoryContent}>
          ...
          <p className={styles.categorySubHeading}>
            Explore a wide range of games, offering thrilling adventures, challenging sports, and
            immersive action gameplay. Discover new worlds, compete with friends, and embark on epic
